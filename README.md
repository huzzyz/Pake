...
> - Automatic icon resolution from [Dashboard Icons](https://dashboardicons.com/) when no explicit icon URL is provided, preferring darker icon variants when available
