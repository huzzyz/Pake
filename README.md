...
> - Automatic icon resolution from [Dashboard Icons](https://dashboardicons.com/) when no explicit icon URL is provided, using the standard base icon asset by default
